...
const SignUp = () => {
  ...
  //   // get login state
  const { login, error } = useSelector((store) => store.userSlice);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen registration ">
      <div className="px-8 py-6 mx-4 mt-4 text-left bg-white rounded-md shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
